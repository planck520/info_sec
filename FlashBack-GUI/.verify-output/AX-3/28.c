 ...
 *    - fromAdvSetMacMtuWan (arg=1, call_ea=0x32760, func_ea=0x325e0, label=needs_check)
 *        call: strcpy(mac - 60, v7);
 *    - websGetVar (arg=ret, call_ea=0x32754, func_ea=source, label=source)
 *        call: v7 = websGetVar(wp, "wanSpeed", "0");
 * ===================================================== */
