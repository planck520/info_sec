 ...
 *    - fromAdvSetMacMtuWan (arg=1, call_ea=0x3273c, func_ea=0x325e0, label=needs_check)
 *        call: strcpy(mac - 68, Var);
 *    - websGetVar (arg=ret, call_ea=0x32730, func_ea=source, label=source)
 *        call: Var = websGetVar(wp, "wanMTU", &byte_794DF);
 * ===================================================== */
