 ...
 *    - get_parentControl_list_Info (arg=1, call_ea=0x47550, func_ea=0x47454, label=certain)
 *        call: strcpy((char *)new_pc_info->mac_addr, src);
 *    - websGetVar (arg=ret, call_ea=0x4749c, func_ea=source, label=source)
 *        call: src = websGetVar(wp, "deviceId", &byte_794DF);
 * ===================================================== */
