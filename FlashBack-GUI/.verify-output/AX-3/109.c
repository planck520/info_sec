 ...
 *    - formGetRebootTimer (arg=1, call_ea=0x57df0, func_ea=0x57d7c, label=certain)
 *        call: GetValue("sys.schedulereboot.enable", enable);
 *    - formSetRebootTimer (arg=1, call_ea=0x57b9c, func_ea=0x57a74, label=needs_check)
 *        call: SetValue("sys.schedulereboot.enable", Var);
 *    - websGetVar (arg=ret, call_ea=0x57abc, func_ea=source, label=source)
 *        call: Var = websGetVar(wp, "autoRebootEn", "1");
 * ===================================================== */
