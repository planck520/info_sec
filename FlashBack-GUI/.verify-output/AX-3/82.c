 ...
 *    - formGetIptv (arg=1, call_ea=0x4fdf0, func_ea=0x4fce4, label=certain)
 *        call: GetValue("iptv.city.vlan", citytag);
 *    - formSetIptv (arg=1, call_ea=0x4fb60, func_ea=0x4f9b0, label=certain)
 *        call: SetValue("iptv.city.vlan", v7);
 *    - websGetVar (arg=ret, call_ea=0x4fab4, func_ea=source, label=source)
 *        call: v7 = websGetVar(wp, "iptvType", &byte_794DF);
 * ===================================================== */
