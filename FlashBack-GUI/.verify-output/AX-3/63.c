 ...
 *    - formSetIPv6status (arg=1, call_ea=0x62940, func_ea=0x62228, label=needs_check)
 *        call: SetValue("ipv6.wan.pppoe.password", v190);
 *    - websGetVar (arg=ret, call_ea=0x6242c, func_ea=source, label=source)
 *        call: v190 = websGetVar(wp, "ISPpassword", &byte_794DF);
 * ===================================================== */
