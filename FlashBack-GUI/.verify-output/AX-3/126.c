 ...
 *    - formGetPPTPServer (arg=1, call_ea=0x49918, func_ea=0x497d0, label=certain)
 *        call: GetValue("vpn.ser.pptpdmppe", pptp_server_mppe);
 *    - formSetPPTPServer (arg=1, call_ea=0x48f44, func_ea=0x48bac, label=needs_check)
 *        call: SetValue("vpn.ser.pptpdmppe", v15);
 *    - websGetVar (arg=ret, call_ea=0x48dcc, func_ea=source, label=source)
 *        call: v15 = websGetVar(wp, "mppe", "1");
 * ===================================================== */
