 ...
 *    - formSetIPv6status (arg=1, call_ea=0x64fb0, func_ea=0x62228, label=needs_check)
 *        call: GetValue("ipv6.wan.pppoe.password", s);
 *    - setPppoeConfig (arg=1, call_ea=0x2ec44, func_ea=0x2e900, label=certain)
 *        call: SetValue("ipv6.wan.pppoe.password", v5);
 *    - websGetVar (arg=ret, call_ea=0x2eb9c, func_ea=source, label=source)
 *        call: v5 = websGetVar(wp, "adslPwd2", &byte_794DF);
 * ===================================================== */
