 ...
 *    - formGetIPv6status (arg=1, call_ea=0x61134, func_ea=0x60b48, label=certain)
 *        call: GetValue("ipv6.wan.dns2", value);
 *    - formSetIPv6status (arg=1, call_ea=0x62cd8, func_ea=0x62228, label=needs_check)
 *        call: SetValue("ipv6.wan.dns2", v193);
 *    - websGetVar (arg=ret, call_ea=0x624a8, func_ea=source, label=source)
 *        call: v193 = websGetVar(wp, "wanAltDNS", &byte_794DF);
 * ===================================================== */
