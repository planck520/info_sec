 ...
 *    - saveParentControlInfo (arg=1, call_ea=0x47830, func_ea=0x47788, label=needs_check)
 *        call: strcpy((char *)v6->mac_addr, Var);
 *    - websGetVar (arg=ret, call_ea=0x477d0, func_ea=source, label=source)
