 ...
 *    - fromGetSysTime (arg=1, call_ea=0x57900, func_ea=0x576e8, label=certain)
 *        call: GetValue("sys.timentpserver", timentpserver);
 *    - fromSetSysTime (arg=1, call_ea=0x5741c, func_ea=0x57254, label=needs_check)
 *        call: v8 = SetValue("sys.timentpserver", v7);
