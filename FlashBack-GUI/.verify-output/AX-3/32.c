 ...
 *    - fromAdvSetMacMtuWan (arg=1, call_ea=0x327ec, func_ea=0x325e0, label=needs_check)
 *        call: strcpy(mac - 68, v12);
 *    - websGetVar (arg=ret, call_ea=0x327e0, func_ea=source, label=source)
 *        call: v12 = websGetVar(wp, "wanMTU2", &byte_794DF);
 * ===================================================== */
