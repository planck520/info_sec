 ...
 *    - formSetIPv6status (arg=1, call_ea=0x628d8, func_ea=0x62228, label=needs_check)
 *        call: SetValue("ipv6.wan.pppoe.username", v10);
 *    - websGetVar (arg=ret, call_ea=0x62414, func_ea=source, label=source)
 *        call: v10 = websGetVar(wp, "ISPusername", &byte_794DF);
 * ===================================================== */
