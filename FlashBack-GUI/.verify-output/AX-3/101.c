 ...
 *    - formAdvGetLanIp (arg=1, call_ea=0x51f74, func_ea=0x51d54, label=certain)
 *        call: GetValue("dhcps.leasetime", dhcps_lease_time);
 *    - fromAdvSetLanip (arg=1, call_ea=0x5198c, func_ea=0x511bc, label=certain)
 *        call: SetValue("dhcps.leasetime", v16);
 *    - websGetVar (arg=ret, call_ea=0x5136c, func_ea=source, label=source)
 *        call: v16 = websGetVar(wp, "leaseTime", "86400");
 * ===================================================== */
