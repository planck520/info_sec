 ...
 *    - form_fast_setting_wifi_set (arg=1, call_ea=0x2dbc4, func_ea=0x2d628, label=certain)
 *        call: GetValue("sys.userpass", par);
 *    - fromSysToolChangePwd (arg=1, call_ea=0x54498, func_ea=0x543c4, label=needs_check)
 *        call: v9 = SetValue("sys.userpass", v5);
