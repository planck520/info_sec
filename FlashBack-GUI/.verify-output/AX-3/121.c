 ...
 *    - formGetPPTPClient (arg=1, call_ea=0x4abe8, func_ea=0x4a9bc, label=needs_check)
 *        call: GetValue("vpn.cli.pptpnetmsk", client_mask);
 *    - formSetPPTPClient (arg=1, call_ea=0x4a614, func_ea=0x4a210, label=needs_check)
 *        call: v16 = SetValue("vpn.cli.pptpnetmsk", v24);
 *    - websGetVar (arg=ret, call_ea=0x4a4a4, func_ea=source, label=source)
 *        call: v24 = websGetVar(wp, "clientMask", &byte_794DF);
 * ===================================================== */
