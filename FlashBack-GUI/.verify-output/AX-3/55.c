 ...
 *    - get_routestatic_wisp_mode (arg=1, call_ea=0x4e95c, func_ea=0x4e820, label=needs_check)
 *        call: GetValue("wl.wisp.gateway", wifi_status.wan_gw);
 *    - setStaticConfig (arg=1, call_ea=0x2e710, func_ea=0x2e620, label=needs_check)
 *        call: SetValue("wl.wisp.gateway", v6);
 *    - websGetVar (arg=ret, call_ea=0x2e6a0, func_ea=source, label=source)
 *        call: v6 = websGetVar(wp, "gateway", "0.0.0.0");
 * ===================================================== */
