 ...
 *    - fromSetSysTime (arg=1, call_ea=0x573a0, func_ea=0x57254, label=needs_check)
 *        call: strcpy((char *)&v23, v5);
 *    - websGetVar (arg=ret, call_ea=0x57334, func_ea=source, label=source)
 *        call: v5 = websGetVar(wp, "timeZone", &byte_794DF);
 * ===================================================== */
