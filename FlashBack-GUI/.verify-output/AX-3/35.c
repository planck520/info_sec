 ...
 *    - fromAdvSetMacMtuWan (arg=1, call_ea=0x32844, func_ea=0x325e0, label=needs_check)
 *        call: strcpy(mac, v15);
 *    - websGetVar (arg=ret, call_ea=0x32838, func_ea=source, label=source)
 *        call: v15 = websGetVar(wp, "mac2", &byte_794DF);
 * ===================================================== */
