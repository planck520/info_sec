 ...
 *    - formSetIPv6status (arg=1, call_ea=0x6509c, func_ea=0x62228, label=needs_check)
 *        call: GetValue("wan1.ppoe.pwd", v206);
 *    - form_fast_setting_pppoe_set (arg=1, call_ea=0x2cffc, func_ea=0x2cf68, label=certain)
 *        call: SetValue("wan1.ppoe.pwd", v5);
 *    - websGetVar (arg=ret, call_ea=0x2cfdc, func_ea=source, label=source)
 *        call: v5 = websGetVar(wp, "password", &byte_794DF);
 * ===================================================== */
