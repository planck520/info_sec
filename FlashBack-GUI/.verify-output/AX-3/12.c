 ...
 *    - umAddUser (arg=4, call_ea=0x211b0, func_ea=0x210f4, label=certain)
 *        call: v9 = dbWriteStr(didUM, "users", "name", v10, user);
 *    - formAddUser (arg=0, call_ea=0x22c1c, func_ea=0x22adc, label=needs_check)
 *        call: umAddUser(Var, v5, v7, 0, v10);
 *    - websGetVar (arg=ret, call_ea=0x22b04, func_ea=source, label=source)
 *        call: Var = websGetVar(wp, "user", &byte_794DF);
 * ===================================================== */
