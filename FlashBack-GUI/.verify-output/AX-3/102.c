 ...
 *    - formAdvGetLanIp (arg=1, call_ea=0x52004, func_ea=0x51d54, label=certain)
 *        call: GetValue("lan.dns.hand1", lan_dns1);
 *    - fromAdvSetLanip (arg=1, call_ea=0x51764, func_ea=0x511bc, label=needs_check)
 *        call: SetValue("lan.dns.hand1", v8);
 *    - websGetVar (arg=ret, call_ea=0x51448, func_ea=source, label=source)
 *        call: v8 = websGetVar(wp, "lanDns1", &byte_794DF);
 * ===================================================== */
