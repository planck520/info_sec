 ...
 *    - formGetPPTPClient (arg=1, call_ea=0x4ab98, func_ea=0x4a9bc, label=needs_check)
 *        call: GetValue("vpn.cli.pptpMPPE.op", client_mppeop);
 *    - formSetPPTPClient (arg=1, call_ea=0x4a5c4, func_ea=0x4a210, label=needs_check)
 *        call: SetValue("vpn.cli.pptpMPPE.op", v26);
 *    - websGetVar (arg=ret, call_ea=0x4a448, func_ea=source, label=source)
 *        call: v26 = websGetVar(wp, "clientMppeOp", "128");
 * ===================================================== */
