 ...
 *    - fromDhcpSetSer (arg=1, call_ea=0x5276c, func_ea=0x52634, label=needs_check)
 *        call: SetValue("dhcps.end", v6);
 *    - websGetVar (arg=ret, call_ea=0x526bc, func_ea=source, label=source)
 *        call: v6 = websGetVar(wp, "endIp", &byte_794DF);
 * ===================================================== */
