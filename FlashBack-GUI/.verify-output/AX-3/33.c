 ...
 *    - fromAdvSetMacMtuWan (arg=1, call_ea=0x32808, func_ea=0x325e0, label=needs_check)
 *        call: strcpy(mac - 60, v13);
 *    - websGetVar (arg=ret, call_ea=0x327fc, func_ea=source, label=source)
 *        call: v13 = websGetVar(wp, "wanSpeed2", "0");
 * ===================================================== */
