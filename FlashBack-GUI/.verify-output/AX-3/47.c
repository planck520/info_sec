 ...
 *    - fromAddressNat (arg=2, call_ea=0x4f37c, func_ea=0x4f2e8, label=certain)
 *        call: sprintf(list, "%s;%s", Var, v5);
 *    - websGetVar (arg=ret, call_ea=0x4f354, func_ea=source, label=source)
 *        call: Var = websGetVar(wp, "entrys", &byte_794DF);
 * ===================================================== */
