 ...
 *    - formGetIptv (arg=1, call_ea=0x4fde0, func_ea=0x4fce4, label=certain)
 *        call: GetValue("adv.iptv.stbpvid", stbpvid);
 *    - setIptvStb (arg=1, call_ea=0x4f8e4, func_ea=0x4f860, label=certain)
 *        call: SetValue("adv.iptv.stbpvid", v6);
 *    - formSetIptv (arg=1, call_ea=0x4fbfc, func_ea=0x4f9b0, label=needs_check)
 *        call: setIptvStb(v5, v6, v7);
 *    - websGetVar (arg=ret, call_ea=0x4faa0, func_ea=source, label=source)
 *        call: v6 = websGetVar(wp, "vlanId", &byte_794DF);
 * ===================================================== */
