 ...
 *    - formGetSchedLed (arg=1, call_ea=0x4f638, func_ea=0x4f580, label=certain)
 *        call: GetValue("sys.sched.led.closetype", close_type);
 *    - formSetSchedLed (arg=1, call_ea=0x4f4e0, func_ea=0x4f428, label=needs_check)
 *        call: v7 = SetValue("sys.sched.led.closetype", v6);
 *    - websGetVar (arg=ret, call_ea=0x4f49c, func_ea=source, label=source)
 *        call: v6 = websGetVar(wp, "ledCloseType", "allClose");
 * ===================================================== */
