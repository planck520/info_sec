 ...
 *    - formGetAdvanceStatus (arg=1, call_ea=0x5ea7c, func_ea=0x5e8c0, label=certain)
 *        call: GetValue("sys.sched.led.type", mib_value);
 *    - formSetSchedLed (arg=1, call_ea=0x4f4ac, func_ea=0x4f428, label=certain)
 *        call: SetValue("sys.sched.led.type", Var);
 *    - websGetVar (arg=ret, call_ea=0x4f46c, func_ea=source, label=source)
 *        call: Var = websGetVar(wp, "ledType", "open");
 * ===================================================== */
