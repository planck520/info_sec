 ...
 *    - formGetSysToolDDNS (arg=1, call_ea=0x50a8c, func_ea=0x509cc, label=certain)
 *        call: GetValue("adv.ddns1.pwd", ddns_pwd);
 *    - formSetSysToolDDNS (arg=1, call_ea=0x50450, func_ea=0x5035c, label=certain)
 *        call: SetValue("adv.ddns1.pwd", v6);
 *    - websGetVar (arg=ret, call_ea=0x503fc, func_ea=source, label=source)
 *        call: v6 = websGetVar(wp, "ddnsPwd", "0");
 * ===================================================== */
