 ...
 *    - fromAdvSetMacMtuWan (arg=1, call_ea=0x32824, func_ea=0x325e0, label=needs_check)
 *        call: strcpy(mac - 44, v14);
 *    - websGetVar (arg=ret, call_ea=0x32818, func_ea=source, label=source)
 *        call: v14 = websGetVar(wp, "cloneType2", "0");
 * ===================================================== */
