 ...
 *    - setSchedWifi (arg=1, call_ea=0x3d7d0, func_ea=0x3d5d0, label=needs_check)
 *        call: strcpy(v10 + 10, v6);
 *    - websGetVar (arg=ret, call_ea=0x3d690, func_ea=source, label=source)
 *        call: v6 = websGetVar(wp, "schedEndTime", &byte_794DF);
 * ===================================================== */
