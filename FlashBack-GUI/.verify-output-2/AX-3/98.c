 ...
 *    - fromDhcpSetSer (arg=1, call_ea=0x5275c, func_ea=0x52634, label=needs_check)
 *        call: SetValue("dhcps.start", v5);
 *    - websGetVar (arg=ret, call_ea=0x526a4, func_ea=source, label=source)
 *        call: v5 = websGetVar(wp, "startIp", &byte_794DF);
 * ===================================================== */
