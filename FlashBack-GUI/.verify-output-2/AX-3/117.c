 ...
 *    - formGetPPTPClient (arg=1, call_ea=0x4aba8, func_ea=0x4a9bc, label=needs_check)
 *        call: GetValue("vpn.cli.pptpPUN", client_userName);
 *    - formSetPPTPClient (arg=1, call_ea=0x4a5d4, func_ea=0x4a210, label=needs_check)
 *        call: SetValue("vpn.cli.pptpPUN", v12);
 *    - websGetVar (arg=ret, call_ea=0x4a460, func_ea=source, label=source)
 *        call: v12 = websGetVar(wp, "userName", &byte_794DF);
 * ===================================================== */
