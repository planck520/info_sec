 ...
 *    - formGetSysToolDDNS (arg=1, call_ea=0x50a9c, func_ea=0x509cc, label=certain)
 *        call: GetValue("adv.ddns1.domain", ddns_domain);
 *    - formSetSysToolDDNS (arg=1, call_ea=0x50460, func_ea=0x5035c, label=certain)
 *        call: SetValue("adv.ddns1.domain", v7);
 *    - websGetVar (arg=ret, call_ea=0x50410, func_ea=source, label=source)
 *        call: v7 = websGetVar(wp, "ddnsDomain", "0");
 * ===================================================== */
