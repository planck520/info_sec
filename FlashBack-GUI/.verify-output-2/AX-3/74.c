 ...
 *    - formGetAdvanceStatus (arg=1, call_ea=0x5ea3c, func_ea=0x5e8c0, label=certain)
 *        call: GetValue("wans.wanweben", remoteWeb);
 *    - formSetSafeWanWebMan (arg=1, call_ea=0x53e84, func_ea=0x53dcc, label=certain)
 *        call: SetValue("wans.wanweben", v5);
 *    - websGetVar (arg=ret, call_ea=0x53e3c, func_ea=source, label=source)
 *        call: v5 = websGetVar(wp, "remoteWebEn", &byte_794DF);
 * ===================================================== */
