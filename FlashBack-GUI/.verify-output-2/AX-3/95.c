 ...
 *    - formGetIPv6status (arg=1, call_ea=0x616a4, func_ea=0x60b48, label=certain)
 *        call: GetValue("ipv6.tun6in4.remoteip", value);
 *    - formSetIPv6status (arg=1, call_ea=0x62ec8, func_ea=0x62228, label=certain)
 *        call: SetValue("ipv6.tun6in4.remoteip", v12);
 *    - websGetVar (arg=ret, call_ea=0x624d8, func_ea=source, label=source)
 *        call: v12 = websGetVar(wp, "remoteIP", &byte_794DF);
 * ===================================================== */
