 ...
 *    - fromAdvSetMacMtuWan (arg=1, call_ea=0x32780, func_ea=0x325e0, label=needs_check)
 *        call: strcpy(mac - 44, v8);
 *    - websGetVar (arg=ret, call_ea=0x32774, func_ea=source, label=source)
