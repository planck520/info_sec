 ...
 *    - formGetIPv6status (arg=1, call_ea=0x610ac, func_ea=0x60b48, label=certain)
 *        call: GetValue("ipv6.wan.dns1", value);
 *    - formSetIPv6status (arg=1, call_ea=0x62c68, func_ea=0x62228, label=needs_check)
 *        call: SetValue("ipv6.wan.dns1", v192);
 *    - websGetVar (arg=ret, call_ea=0x62490, func_ea=source, label=source)
 *        call: v192 = websGetVar(wp, "wanPreDNS", &byte_794DF);
 * ===================================================== */
