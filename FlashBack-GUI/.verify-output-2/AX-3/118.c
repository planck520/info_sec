 ...
 *    - formGetPPTPClient (arg=1, call_ea=0x4abb8, func_ea=0x4a9bc, label=needs_check)
 *        call: GetValue("vpn.cli.pptpPPW", client_password);
 *    - formSetPPTPClient (arg=1, call_ea=0x4a5e4, func_ea=0x4a210, label=needs_check)
 *        call: SetValue("vpn.cli.pptpPPW", v13);
 *    - websGetVar (arg=ret, call_ea=0x4a478, func_ea=source, label=source)
 *        call: v13 = websGetVar(wp, "password", &byte_794DF);
 * ===================================================== */
