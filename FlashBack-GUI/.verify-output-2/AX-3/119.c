 ...
 *    - formGetPPTPClient (arg=1, call_ea=0x4abc8, func_ea=0x4a9bc, label=needs_check)
 *        call: GetValue("vpn.cli.pptpservIP", client_domain);
 *    - formSetPPTPClient (arg=1, call_ea=0x4a5f4, func_ea=0x4a210, label=needs_check)
 *        call: SetValue("vpn.cli.pptpservIP", v11);
 *    - websGetVar (arg=ret, call_ea=0x4a40c, func_ea=source, label=source)
 *        call: v11 = websGetVar(wp, "domain", &byte_794DF);
 * ===================================================== */
