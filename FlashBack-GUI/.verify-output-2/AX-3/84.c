 ...
 *    - fromSysToolTime (arg=1, call_ea=0x5717c, func_ea=0x56f38, label=certain)
 *        call: v15 = SetValue("sys.timefixper", v17);
 *    - websGetVar (arg=ret, call_ea=0x56ff0, func_ea=source, label=source)
 *        call: v17 = websGetVar(wp, "SETPRIO", &byte_794DF);
 * ===================================================== */
