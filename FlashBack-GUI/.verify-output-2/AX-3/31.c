 ...
 *    - fromAdvSetMacMtuWan (arg=1, call_ea=0x327c0, func_ea=0x325e0, label=needs_check)
 *        call: strcpy(mac + 18, v10);
 *    - websGetVar (arg=ret, call_ea=0x327b4, func_ea=source, label=source)
 *        call: v10 = websGetVar(wp, "serviceName", &byte_794DF);
 * ===================================================== */
