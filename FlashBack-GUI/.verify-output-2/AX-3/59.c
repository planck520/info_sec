 ...
 *    - formSetIPv6status (arg=1, call_ea=0x6424c, func_ea=0x62228, label=certain)
 *        call: SetValue("ipv6.enable", v105);
 *    - websGetVar (arg=ret, call_ea=0x641d0, func_ea=source, label=source)
 *        call: v105 = websGetVar(wp, "IPv6En", "0");
 * ===================================================== */
