 ...
 *    - formGetIPv6status (arg=1, call_ea=0x618c0, func_ea=0x60b48, label=certain)
 *        call: GetValue("ipv6.tun6rd.remotemask", value);
 *    - formSetIPv6status (arg=1, call_ea=0x63ba4, func_ea=0x62228, label=needs_check)
 *        call: SetValue("ipv6.tun6rd.remotemask", v194);
 *    - websGetVar (arg=ret, call_ea=0x624c0, func_ea=source, label=source)
 *        call: v194 = websGetVar(wp, "wanMask", &byte_794DF);
 * ===================================================== */
