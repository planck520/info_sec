 ...
 *    - formGetIPv6status (arg=1, call_ea=0x60e2c, func_ea=0x60b48, label=certain)
 *        call: GetValue("ipv6.wan.d6c.iapd", value);
 *    - formSetIPv6status (arg=1, call_ea=0x62774, func_ea=0x62228, label=needs_check)
 *        call: SetValue("ipv6.wan.d6c.iapd", v11);
 *    - websGetVar (arg=ret, call_ea=0x62448, func_ea=source, label=source)
 *        call: v11 = websGetVar(wp, "prefixDelegate", "1");
 * ===================================================== */
