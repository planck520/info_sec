 ...
 *    - fromAdvSetMacMtuWan (arg=1, call_ea=0x32864, func_ea=0x325e0, label=needs_check)
 *        call: strcpy(mac + 18, v16);
 *    - websGetVar (arg=ret, call_ea=0x32858, func_ea=source, label=source)
 *        call: v16 = websGetVar(wp, "serviceName2", &byte_794DF);
 * ===================================================== */
