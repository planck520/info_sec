 ...
 *    - get_parentControl_list_Info (arg=1, call_ea=0x4755c, func_ea=0x47454, label=certain)
 *        call: strcpy(new_pc_info->time, v5);
 *    - websGetVar (arg=ret, call_ea=0x474cc, func_ea=source, label=source)
 *        call: v5 = websGetVar(wp, "time", &byte_794DF);
 * ===================================================== */
