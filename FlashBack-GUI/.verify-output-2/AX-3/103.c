 ...
 *    - formAdvGetLanIp (arg=1, call_ea=0x52014, func_ea=0x51d54, label=certain)
 *        call: GetValue("lan.dns.hand2", lan_dns2);
 *    - fromAdvSetLanip (arg=1, call_ea=0x51818, func_ea=0x511bc, label=needs_check)
 *        call: SetValue("lan.dns.hand2", v9);
 *    - websGetVar (arg=ret, call_ea=0x51460, func_ea=source, label=source)
 *        call: v9 = websGetVar(wp, "lanDns2", &byte_794DF);
 * ===================================================== */
