 ...
 *    - formGetSysToolDDNS (arg=1, call_ea=0x50a7c, func_ea=0x509cc, label=certain)
 *        call: GetValue("adv.ddns1.user", ddns_user);
 *    - formSetSysToolDDNS (arg=1, call_ea=0x50440, func_ea=0x5035c, label=certain)
 *        call: SetValue("adv.ddns1.user", v5);
 *    - websGetVar (arg=ret, call_ea=0x503e0, func_ea=source, label=source)
 *        call: v5 = websGetVar(wp, "ddnsUser", "0");
 * ===================================================== */
