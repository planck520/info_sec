 ...
 *    - formGetPPTPClient (arg=1, call_ea=0x4abd8, func_ea=0x4a9bc, label=needs_check)
 *        call: GetValue("vpn.cli.pptpnetseg", client_seg);
 *    - formSetPPTPClient (arg=1, call_ea=0x4a604, func_ea=0x4a210, label=needs_check)
 *        call: SetValue("vpn.cli.pptpnetseg", fmt);
 *    - websGetVar (arg=ret, call_ea=0x4a490, func_ea=source, label=source)
 *        call: fmt = websGetVar(wp, "clientIp", &byte_794DF);
 * ===================================================== */
