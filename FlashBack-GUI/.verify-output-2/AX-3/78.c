 ...
 *    - formGetAdvanceStatus (arg=1, call_ea=0x5ebb8, func_ea=0x5e8c0, label=certain)
 *        call: GetValue("wan1.dmzen", dmz_en);
 *    - mDMZSetCfg (arg=1, call_ea=0x4d4c4, func_ea=0x4d400, label=needs_check)
 *        call: SetValue("wan1.dmzen", Var);
 *    - websGetVar (arg=ret, call_ea=0x4d450, func_ea=source, label=source)
 *        call: Var = websGetVar(wp, "dmzEn", "0");
 * ===================================================== */
