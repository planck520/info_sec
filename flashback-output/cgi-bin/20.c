 ...
 *    - sub_425D60 (arg=0, call_ea=0x425e58, func_ea=0x425d60, label=needs_check)
 *        call: memset(v8, 0, v5);
 *    - websGetVar (arg=ret, call_ea=0x425dd0, func_ea=source, label=source)
 *        call: v3 = websGetVar(a1, "ContentLength", &byte_431360);
 * ===================================================== */
