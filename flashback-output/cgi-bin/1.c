 ...
 *    - sub_41E0A0 (arg=1, call_ea=0x41ee6c, func_ea=0x41e0a0, label=needs_check)
 *        call: doSystem("echo  '%s'  > /proc/sys/kernel/hostname", v48);
 *    - websGetVar (arg=ret, call_ea=0x41ee38, func_ea=source, label=source)
 *        call: v48 = (const char *)websGetVar(a1, "hostName", &byte_431360);
 * ===================================================== */
