...
function initValue(obj) {
	...
	setWrlCurrent(obj);
        if (obj.wl_mode == "apclient") {
                document.getElementById("adv_mode").disabled=true;
                document.getElementById("adv_mode_5g").disabled=true;		
                document.getElementById("adv_band").disabled=true;
                document.getElementById("adv_band_5g").disabled=true;
                document.getElementById("adv_channel").disabled=true;
                document.getElementById("adv_channel_5g").disabled=true;
