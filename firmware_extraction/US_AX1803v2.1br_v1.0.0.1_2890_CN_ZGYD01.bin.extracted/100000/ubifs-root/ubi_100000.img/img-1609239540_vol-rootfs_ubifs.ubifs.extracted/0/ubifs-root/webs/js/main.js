...
staInfo = {
    ...
    showWorkMode: function (workMode, nodeType) {7
        var hideArr = [];
        ...
        if (workMode == "ap" || workMode == "client+ap") {
            ...
            $("[href='#parent-control']").parent().addClass("none");
            hideArr = ["wrl_guest", "adv_netcontrol", "adv_firewall", "adv_ddns", "adv_virtualServer", "adv_dmz", "adv_route", "adv_upnp", "ip_mac_bind", "sys_wan", "adv_remoteweb"];
        ...
        if(nodeType === "agent") { //子节点信息
            ...
            hideArr = ["adv_netcontrol", "adv_macFilter", "adv_firewall", "adv_virtualServer", "adv_dmz", "adv_route", "adv_upnp", "adv_remoteweb"];
            hideArr.push("sys_lan_status", "sys_backup");
            //次节点下隐藏以下模块
			hideArr.push("wrl_channel", "wrl_signal", "wrl_access", "wrl_guest", "wrl_wps", "wrl_ofdma");
        }
        if(workMode == 'router'){
    ...
    setAPMode: function (obj) {
        ...
        $("#statusMeshConnected").addClass("none");
        //TODO: 设置是否连接上级成功
        if (obj.apStatus === "2303002" || obj.apStatus === "2302003") {
            $("#statusApConnected").removeClass("none");
        } else {
...
wrlInfo = {
    ...
    getIframe: function () {
        ...
        switch (id) {
            ...
            case "wrl_meshSwitch":
                if ($(this).hasClass("disabled-wisp")) {
                    alert("请先关闭“无线中继”功能，再开启MESH组网扩展！");
                    return;
                }
    ...
    setValue: function (obj) {
        ...
        if(obj.wispEn == "0") {
            $("#wrl_meshSwitch").removeClass("disabled-wisp");
        } else {
            $("#wrl_meshSwitch").addClass("disabled-wisp");
        }
