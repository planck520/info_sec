...
function checkData() {
	G.validate = $.validate({
		custom: function () {
			...
			if(G.provinceCode == 'SHA'){
				if (($("#security_2").val() !== "none") && ($("#wrlPwd_2").val() === "")) {
					return _("SSID2无线密码不能为空");
				}
				if (($("#security_3").val() !== "none") && ($("#wrlPwd_3").val() === "")) {
					return _("SSID3无线密码不能为空");
				}
				if (($("#security_4").val() !== "none") && ($("#wrlPwd_4").val() === "")) {
					return _("SSID4无线密码不能为空");
				}
				if (($("#security_6").val() !== "none") && ($("#wrlPwd_6").val() === "")) {
					return _("SSID6无线密码不能为空");
				}
				if (($("#security_7").val() !== "none") && ($("#wrlPwd_7").val() === "")) {
					return _("SSID7无线密码不能为空");
				}
				if (($("#security_8").val() !== "none") && ($("#wrlPwd_8").val() === "")) {
					return _("SSID8无线密码不能为空");
				}
			}
		},
...
function initValue(obj) {
	...
	$("#wrlPwd_2").initPassword("", false, false);
	$("#wrlPwd_3").initPassword("", false, false);
	$("#wrlPwd_4").initPassword("", false, false);
	$("#wrlPwd_6").initPassword("", false, false);
	$("#wrlPwd_7").initPassword("", false, false);
	$("#wrlPwd_8").initPassword("", false, false);
	...
	$.getJSON("goform/getMeshStatus?" + Math.random(), function (obj){
