...
function hideEditNameArea(rowEle, devName) {
	$(rowEle).find(".dev-name").html(toHtmlCode(devName)).attr("title", devName).append('<img class="edit-btn edit-btn-txt-append" src="img/edit_new.png?4cdfafd6392d58c98648733c1d18de89" style="width:14px;height:14px;"/>');
}
	...
	str += "<td class='edit-td'>" + 
				...
				"<div class='online-device-content'>" + 
					"<div class='dev-name text-fixed' style='padding-right: 30px;'>" + 
						...
						"</span>" + 
						"<img class='edit-btn edit-btn-txt-append' src='img/edit_new.png?4cdfafd6392d58c98648733c1d18de89' style='width:14px;height:14px;' />" + 
					"</div>" + 
