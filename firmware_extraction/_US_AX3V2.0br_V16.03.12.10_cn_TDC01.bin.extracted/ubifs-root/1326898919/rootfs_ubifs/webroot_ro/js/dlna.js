...
function getMoreFolder(folderId, subData) {
    ...
    if ($("#" + folderId).html() !== "") {
        ...
        //显示搜索图标
        $(".folder-scan").css("background", "url(/img/scan.gif?4cdfafd6392d58c98648733c1d18de89) 0 no-repeat");
