...
function changeImg(imgID, powerValue) {
    ...
    if (powerValue == "low") {
        $imgDom.attr("src", "../img/icon-power-gray1.png?4cdfafd6392d58c98648733c1d18de89");
    } else if (powerValue == "middle") {
        $imgDom.attr("src", "../img/icon-power-gray2.png?4cdfafd6392d58c98648733c1d18de89");
    } else {
        $imgDom.attr("src", "../img/icon-power.png?4cdfafd6392d58c98648733c1d18de89");
    }
}
