...
function initValue (obj) {
    ...
    $('#wrlPassword').initPassword(_("WiFi password of 8-63 characters"), false, false);
    ...
    /*else if (!$("#dhcp_setting").hasClass("none")) {
        ...
        if (((wrlPwd !== "") && ($("#hideWrlPwd")[0].checked === false)) || $("#eLink").val() == "1") {
            ...
            if($("#eLink").val() != "1") { // elink未开启
                ...
                if (!/^[\x00-\x80]{8,63}$/.test(wrlPwd)) {
                    showErrMsg("message-ssid", _("WiFi Password must consist of 8-63 characters."));
                    return;
                }
            }
